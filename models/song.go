/*
Package models содержит структуры данных, используемые в музыкальной библиотеке.
Он включает модели для представления песен, их деталей, а также структуры ответов API для обработки запросов, связанных с песнями.
Структуры в этом пакете обеспечивают связь между входными данными, данными в базе и ответами на запросы.
*/
package models
